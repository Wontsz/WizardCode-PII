...
class Player(pygame.sprite.Sprite):
    ...
    def atualizar_informacoes(self):
        ...
        #texto_vida = fonte.render("Vida: " + str(vida), True, (0, 0, 0))  # Preto
...
# NOME DA TELA
pygame.display.set_caption('WIZARD CODE!')
...
while not done:
    ...
    # MUDA O SPRITE DO JOGADOR DE ACORDO COM A QUANTIDADE DE ACERTOS
    if 2 > acertos >= 1:
